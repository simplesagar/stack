...
public class WorkflowInstanceHistoryStage {
    @JsonProperty("attempt")public Long attempt;
    ...
    @JsonProperty("input")public WorkflowInstanceHistoryStageInput input;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("lastFailure")public String lastFailure;
    ...
    @JsonProperty("nextExecution")public OffsetDateTime nextExecution;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("output")public WorkflowInstanceHistoryStageOutput output;

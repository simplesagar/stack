...
public class StageSendDestination {
    ...
    @JsonProperty("account")public StageSendDestinationAccount account;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("payment")public StageSendDestinationPayment payment;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("wallet")public StageSendDestinationWallet wallet;

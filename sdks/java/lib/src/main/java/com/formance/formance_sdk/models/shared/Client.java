...
public class Client {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("postLogoutRedirectUris")public String[] postLogoutRedirectUris;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("redirectUris")public String[] redirectUris;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("secrets")public ClientSecret[] secrets;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("trusted")public Boolean trusted;

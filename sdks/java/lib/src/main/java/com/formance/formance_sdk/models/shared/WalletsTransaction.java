...
public class WalletsTransaction {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("postCommitVolumes")public java.util.Map<String, java.util.Map<String, WalletsVolume>> postCommitVolumes;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("preCommitVolumes")public java.util.Map<String, java.util.Map<String, WalletsVolume>> preCommitVolumes;
    ...
    @JsonProperty("txid")public Long txid;

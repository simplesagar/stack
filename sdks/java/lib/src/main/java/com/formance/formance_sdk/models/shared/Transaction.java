...
public class Transaction {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("postCommitVolumes")public java.util.Map<String, java.util.Map<String, Volume>> postCommitVolumes;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("preCommitVolumes")public java.util.Map<String, java.util.Map<String, Volume>> preCommitVolumes;

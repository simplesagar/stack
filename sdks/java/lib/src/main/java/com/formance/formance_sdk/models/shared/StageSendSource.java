...
public class StageSendSource {
    ...
    @JsonProperty("account")public StageSendSourceAccount account;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("payment")public StageSendSourcePayment payment;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("wallet")public StageSendSourceWallet wallet;
